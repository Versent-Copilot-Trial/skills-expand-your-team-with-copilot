...
def get_activities(
    ...
    - difficulty: Filter activities by difficulty level (e.g., 'Beginner', 'Intermediate', 'Advanced', or 'Unspecified' for activities with no difficulty)
    """
    ...
    if difficulty:
        if difficulty == "Unspecified":
            # "Unspecified" means activities with no difficulty field
